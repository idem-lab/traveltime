...
::: {.cell-output-display}
![Motorised travel time from healthcare facilities in Cambodia](paper_files/figure-html/fig-tt_healthcare-1.png){#fig-tt_healthcare}
:::
:::
...
::: {.cell-output-display}
![Base map of Singapore](paper_files/figure-html/fig-basemap-1.png){#fig-basemap}
:::
:::
...
::: {.cell-output-display}
![Friction surface raster of Singapore, showing boundary from @fig-basemap and station locations as grey points](paper_files/figure-html/fig-data-1.png){#fig-data}
:::
:::
