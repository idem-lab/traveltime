...
::: {.cell}
::: {.cell-output-display}
![Existing surface of motorised travel time from healthcare facilities, exerpted to Cambodia (Weiss et al., 2020)](paper_files/figure-html/fig-tt_healthcare-1.png){#fig-tt_healthcare}
:::
:::
...
# Example workflow: walking home from public transport in Singapore
...
-   our points to calcute travel time from, that is, the locations of Singapore's MRT and LRT stations.
