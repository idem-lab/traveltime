...
\hypersetup{
  pdftitle={traveltime: an R package to calculate walking and motorised travel time from user-specified locations},
  hidelinks,
...
\begin{flushleft}
{\Large
\textbf\newline{\texttt{traveltime}: an R package to calculate walking
and motorised travel time from user-specified
...
\includegraphics{paper_files/figure-pdf/fig-result-1.pdf}
