---
title: "A practical example: walking from public transport in Singapore"
output: rmarkdown::html_vignette
authors:
  Gerry Ryan
vignette: >
  %\VignetteIndexEntry{A practical example: walking from public transport in Singapore}
...
We will use the friction surface from Weiss et al. (2020)[^1] that can be downloaded by `traveltime` with the function `get_friction_surface()`. This function takes extents in a variety of formats and returns the surface for that extent only.
